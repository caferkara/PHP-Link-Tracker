      ...
      <div class="main-panel">
        ...
        <div class="container">
          <div class="page-inner">
            ...
            <div>
                <h3 class="fw-bold mb-3">Link Tracking</h3>
              </div>
                  ...
                  <div class="card-body">
                    <div class="table-responsive">
                      <table
                        ...
                        <td>
                            <a class="button edit" href="edit-link.php?id=<?php echo $link['id']; ?>"><span class="badge badge-warning">Edit</span></a>
                            <a class="button delete" href="javascript:void(0);" onclick="confirmDelete('<?php echo $link['id']; ?>')"><span class="badge badge-danger">Delete</span></a>
                            <a class="button copy" href="javascript:void(0);" onclick="copyToClipboard('<?php echo $link['id']; ?>')"><span class="badge badge-primary">Copy Link</span></a>
...
function confirmDelete(id) {
    if (confirm("Are you sure you want to delete this item?")) {
        window.location.href = 'tracker.php?delete=' + id;
    }
}
</script>
